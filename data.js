// ============================================================
// data.js — Task Model, CRUD, localStorage, Seed Data
// ============================================================
...
// ── Seed Data ────────────────────────────────────────────────
function seedData() {
  if (_tasks.length > 0) return; // don't overwrite existing data
  ...
  const samples = [
    // Inbox tasks (fresh)
    {
      title: 'HQ 월간 보고서 제출',
      requester: '이부장',
      category: 'HQ Reporting',
      priority: 'P1',
      status: 'Inbox',
      received_date: daysFromNow(-1),
    ...
    },
    {
      ...
      status: 'Inbox',
      received_date: today(),
      description: '3건의 공급업체 청구서 검토 및 승인 필요'
    },
    {
      title: '법인세 신고 서류 검토',
      requester: '박세무사',
      ...
      priority: 'P1',
      status: 'Clarifying',
      received_date: daysFromNow(-3),
      due_date: daysFromNow(5),
      estimated_time: 120,
      next_action: '원천징수 확인서 수령 후 검토 시작'
    },
    // Planned tasks
    {
      title: '급여 대장 최종 확인',
      ...
      priority: 'P1',
      status: 'Planned',
      received_date: daysFromNow(-2),
      due_date: today(),
      planned_date: today(),
      estimated_time: 45,
      next_action: '시스템에서 데이터 내보내기'
    },
    {
      title: '은행 잔액 조정',
      requester: '재무팀',
    ...
    },
    {
      ...
      priority: 'P1',
      status: 'In Progress',
      received_date: daysFromNow(-5),
      due_date: daysFromNow(-1), // overdue!
      planned_date: today(),
      estimated_time: 180,
      next_action: '전년도 재무제표 대조'
    },
    // Quick tasks
    {
      title: '전신환 수수료 확인 이메일 회신',
      requester: '박대리',
      category: 'Banking',
      priority: 'P3',
      status: 'Planned',
    ...
    {
      title: '내부통제 자료 요청 (HQ)',
      requester: 'HQ Finance',
      category: 'Compliance',
      priority: 'P2',
      status: 'Waiting Reply',
      received_date: daysFromNow(-7),
      due_date: daysFromNow(3),
      waiting_on: 'HQ Finance Team',
      follow_up_date: daysFromNow(1),
      last_follow_up_date: daysFromNow(-2),
      notes: '2차 요청 발송 완료'
    },
    {
      title: 'AR 미수금 회수 확인',
      ...
      priority: 'P2',
      status: 'Waiting Reply',
      received_date: daysFromNow(-4),
      due_date: daysFromNow(2),
      waiting_on: '거래처 담당자 홍길동',
      follow_up_date: today(), // follow-up due today!
      last_follow_up_date: daysFromNow(-3),
    },
    {
      title: '계열사 간 거래 대사',
      requester: '연결팀',
    ...
    // Done tasks
    {
      ...
      priority: 'P1',
      status: 'Done',
      received_date: daysFromNow(-14),
      due_date: daysFromNow(-7),
      completed_date: daysFromNow(-7),
      notes: '특이사항 없음. 정상 마감 완료.'
    },
    {
      title: '법인카드 지출 내역 정리',
      requester: '경영지원팀',
      ...
      received_date: daysFromNow(-5),
      due_date: daysFromNow(-3),
      completed_date: daysFromNow(-3),
      estimated_time: 30,
    },
  ];

  samples.forEach(s => createTask(s));
}
